...
public class BusWarningServiceImpl implements BusWarningService {
	...
	public Integer[] quotaMonitorDetail(int year, int month) throws Exception {
		...
		Integer g1Num = busWarningDao.queryWarnNum(year, month, 1,null);
		Integer g2Num = busWarningDao.queryWarnNum(year, month, 2,null);
		Integer g3Num = busWarningDao.queryWarnNum(year, month, 3,null);
	...
	public List<List<Object>> monitorTrend(Date date) throws Exception {
		...
		Integer num1 = busWarningDao.queryWarnNum(year, month, null,null);
		dateList.add(c1);
		numList.add(num1);
		//值2
		...
		Integer num2 = busWarningDao.queryWarnNum(year, month, null,null);
		dateList.add(c2);
		numList.add(num2);
		//值3
		...
		Integer num3 = busWarningDao.queryWarnNum(year, month, null,null);
		dateList.add(c3);
		numList.add(num3);
		//值4
		...
		Integer num4 = busWarningDao.queryWarnNum(year, month, null,null);
		dateList.add(c4);
		numList.add(num4);
		//值5
		...
		Integer num5 = busWarningDao.queryWarnNum(year, month, null,null);
		dateList.add(c5);
		numList.add(num5);
		//值6
		...
		Integer num6 = busWarningDao.queryWarnNum(year, month, null,null);
		dateList.add(c6);
		numList.add(num6);
		return container;
	}
	...
	public List<List<Object>> deptCount(int year, int month) throws Exception {
		...
		String dept = "";
		Integer queryWarnNum = busWarningDao.queryWarnNum(year, month, null,dept);
