...
<body>
	<div class="maincon" style="overflow: scroll">
		<a href="javascript:void(0);" target="_blank" onclick="nextPage();"
			class="longred"
			style="position: absolute; right: 20px; top: 50%; width: 25px; height: 85px">上一页</a>
		...
		<div class="echartbox" style="margin-top: 50px;">
			<div class="toptitle bordergreen">
				<span class="titles">营销服务规范率</span>
			</div>
		...
		<div class="echartbox">
			<div class="toptitle">
				<span class="titles">优质服务评价指数</span>
			</div>
			<div class="echartpicbox">
		...
		<div class="echartbox">
			<div class="toptitle borderblue">
				<span class="titles">信息通信系统运行指数</span>
			</div>
			<div class="echartpicbox">
	...
	<script type="text/javascript">
		function nextPage() {
			window.location.href = "${ctx}/incl/jingyihua/chartsDetail"
		}
		...
		myChart1.on('click', function(params) {
			...
			loadChart(city);  */
			window.location.href = "${ctx}/incl/jingyihua/newPage5";
			//alert(params);
		});
		myChart1.setOption({
			tooltip : {
		...
		myChart2.on('click', function(params) {
			/* var city = params.name;
			loadChart(city);  */
			window.location.href = "${ctx}/incl/jingyihua/newPage6";
			//alert(params);
		});
		myChart2.setOption({
			tooltip : {
		...
		myChart3.on('click', function(params) {
			/* var city = params.name;
			loadChart(city);  */
			window.location.href = "${ctx}/incl/jingyihua/newPage7";
			//alert(params);
		});
		myChart3.setOption({
			tooltip : {
		...
		myChart4.on('click', function(params) {
			/* var city = params.name;
			loadChart(city);  */
			window.location.href = "${ctx}/incl/jingyihua/newPage8";
			//alert(params);
		});
		myChart4.setOption({
			/* title : {
